...
const Products = () => {
  ...
  useEffect(() => {
    const getProducts = async () => {
      const { data } = await axios("http://localhost:3004/laptop");
      setDatae(data);
    };
    getProducts();
  }, []);
  ...
  const pages = [1, 2, 3]
    return (
      ...
      <div>
        <div className='flex flex-col md:flex-row justify-center items-center gap-5 '>
          <div>
            ...
            >
              ...
              <option value='Pro Laptop'>Pro Laptop</option>
              ...
              <option value='Mid-range Laptop'>Mid-range Laptop</option>
        ...
        {datae.map(item=> <ProductCard key={item._id} item={item}></ProductCard> )}
